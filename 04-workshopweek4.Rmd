...
A [video](https://youtu.be/h5FCt75G-Us) and handwritten notes]() of this worked solution are available.
...
*Formally t is also a variable and this should be treated with partial derivatives, but the answer will still be the same.*
