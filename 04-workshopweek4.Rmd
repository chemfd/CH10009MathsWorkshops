...
2. a. $\dfrac{\textrm{d}I}{\textrm{d}\lambda}= -4I_0 \frac{\pi \alpha ^2}{\varepsilon _r^2 \lambda^5 r^2}(\sin \phi)^2$
...
3. $\dfrac{\textrm{d}V}{\textrm{d}t}= 0.8 \pi r^2= 6$ m^3^ s^-1^,   $\dfrac{\textrm{d}SA}{\textrm{d}t}=1.6 \pi r = 8 \times 10^1$ m^2^ s^-1^
