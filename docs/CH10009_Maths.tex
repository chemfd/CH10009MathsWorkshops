...
\tightlist
\item
  \(z = (2.24e^{1.11i})^9 \equiv(1.40E+03)e^{9.99i}\)
\item
  \(z = (1.41e^{-0.79i})^23 \equiv(2.90E+03)e^{-18.17i}\)
\item
  \(z = (5e^{0.93i})^13 \equiv(1.22E+09)e^{12.09i}\)
\item
  \(z = (2.06e^{-0.24i})^5 \equiv(3.72E+01)e^{-1.2i}\)
\item
  \(z = (3.16e^{-0.32i})^-3 \equiv(3.16E-02)e^{0.96i}\)
\item
  \(z = (2.83e^{0.79i})^-7 \equiv(6.91E-04)e^{-5.53i}\)
\item
  \(z = (9.43e^{-2.58i})^-2 \equiv(1.12E-02)e^{5.16i}\)
\item
  \(z = (9.06e^{-1.68i})^-7 \equiv(2.00E-07)e^{11.76i}\)
\item
  \(z = (5e^{-2.21i})^0 \equiv(1.00E+00)e^{0i}\)
\item
  \(z = (13.45e^{0.84i})^-5 \equiv(2.27E-06)e^{-4.2i}\)
\end{itemize}
