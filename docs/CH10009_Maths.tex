...
\item
  \(\frac{1}{[A]}=\frac{1}{[A]_0}+ kt\)
\item
  \(\ln \frac{p_1}{p_2}=\frac{\Delta_{\textrm{vap}}H}{R}\left({\frac{1}{T_2}-\frac{1}{T_1}}\right)\) \href{https://youtu.be/Eo-lCuGcoP8}{Worked solution} \href{http://workitoutwithapencil.xyz/wp-content/uploads/2021/12/Q6.4.2.3.pdf}{Handwritten solutions}
\item
