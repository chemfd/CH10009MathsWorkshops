...
torr or mm Hg are historic reasons which are still occassionally used in science due to how pressure is sometimes measured. It is an unusual unit as it is related to another non-SI measure of pressure, the \emph{`atmosphere'}, 760 mm Hg (or torr) is the height of mercury measured when the external pressure is 1 atmosphere (or 101325 Pa). \href{https://youtu.be/7HWLV0p5zv4}{An example of converting between torr and Pa can be found here} (\href{http://workitoutwithapencil.xyz/wp-content/uploads/2022/10/Unit-conversions-mmHg-to-Pa.pdf}{and the notes here}).
...
\item
  ...
  \item
    \href{https://youtu.be/UDHRzAC7BnQ}{23.4 × 10\textsuperscript{-3} mg dm\textsuperscript{−3}; 23.4 × 10\textsuperscript{-3} g m\textsuperscript{−3}; and 23.4 × 10\textsuperscript{-6} kg m\textsuperscript{−3}} \href{http://workitoutwithapencil.xyz/wp-content/uploads/2022/10/Q1.4.2.1.c.pdf}{link to notes}
  \item
...
\item
  \(\frac{1}{[A]}=\frac{1}{[A]_0}+ kt\)
\item
  \(\ln \frac{p_1}{p_2}=\frac{\Delta_{\textrm{vap}}H}{R}\left({\frac{1}{T_2}-\frac{1}{T_1}}\right)\) \href{https://youtu.be/Eo-lCuGcoP8}{Worked solution} \href{http://workitoutwithapencil.xyz/wp-content/uploads/2021/12/Q6.4.2.3.pdf}{Handwritten notes}
\item
  \(w = -nRT \ln \frac{V_f}{V_i}\) \href{https://youtu.be/sPXVrnd0DtA}{Worked solution} \href{http://workitoutwithapencil.xyz/wp-content/uploads/2021/12/Q6.4.2.4.pdf}{Handwritten notes}
\end{enumerate}
...
\chapter{Other useful infomation}\label{ch-other}}
