...
Determine the units of the coulomb constant, \(k_e\), in equation \eqref{eq:coulomb}, given that r is the separation of two charges, F the force of attraction between the two charges, and \(q_x\) is teh charge (in coulombs, C) on each of the particles.
...
0.0 kJ mol\textsuperscript{-1} - please note this value is correct to the appropriate sig figs
