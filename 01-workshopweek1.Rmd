...
Table: (\#tab:SIderive) Some common SI derived units used in chemistry. 
...
3. At low temperatures the molar heat capacity of a material $c_{p, m}$ (J K^-1^ mol^-1^) is given by equation \@ref(eq:lowtempheat).
...
4. Determine the units of the coulomb constant, $k_e$, in equation \@ref(eq:coulomb), given that r is the separation of two charges, F the force of attraction between the two charges, and $q_x$ is teh charge (in coulombs, C) on each of the particles.
...
1. $\frac{\Delta H T_2}{\Delta H - R T \ln {x_A}}$

<div style="text-align: center;"><iframe width="847" height="635" src="https://www.youtube.com/embed/WmryM91dcXE" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

1. $\alpha = \frac{-K_a \pm \sqrt{K_a^2 + 4 c K_a}}{2c}$

<div style="text-align: center;"><iframe width="847" height="635" src="https://www.youtube.com/embed/F7em5K2b4to" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
1. 
    ...
    a. 0.2704 kg mol^-1^; 449.0 yg
    
   <div style="text-align: center;"> <iframe width="847" height="635" src="https://www.youtube.com/embed/IKM6a3VxWKs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<div style="text-align: center;"><iframe width="847" height="635" src="https://www.youtube.com/embed/3cuSZZF3Z4Y" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
